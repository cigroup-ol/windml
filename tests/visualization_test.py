...
class TestVisualization(unittest.TestCase):
    ...
    def test_coord_topo_mill(self):
        show_coord_topo_mill(self.windmill, show = False)

    def test_coord_topo_zoom(self):
        show_coord_topo_zoom(self.windpark, show = False)

    def test_plot_timeseries(self):
        plot_timeseries(self.windmill, show = False)

    def test_plot_response_curve(self):
        plot_response_curve(self.windmill, show = False)
